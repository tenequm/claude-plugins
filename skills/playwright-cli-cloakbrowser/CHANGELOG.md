...
- Declared ClawHub browse categories (`automation, research`) and topics in `metadata`, so the release pipeline publishes them instead of leaving the skill in the `other` category.
