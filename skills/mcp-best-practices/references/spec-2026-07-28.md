...
| [Server Card](https://modelcontextprotocol.io/community/working-groups/server-card) | Server self-description at `GET <streamable-http-url>/server-card` | Discovery and cataloging; SEP-2127 still Draft |
