...
| `grill-me` | 0.1.2 | [zip](https://github.com/tenequm/skills/releases/download/skills-latest/grill-me.zip) | [page](https://clawhub.ai/skills/grill-me) | Interview the user relentlessly about a plan or design until reaching shared understanding, resolving each branch of the decision tree. Use when user wants to stress-test a plan, get grilled on their design, or mentions "grill me". |
...
| `pre-compact` | 0.1.1 | [zip](https://github.com/tenequm/skills/releases/download/skills-latest/pre-compact.zip) | [page](https://clawhub.ai/skills/pre-compact) | Prepare the session for context compaction - write a handoff file a fresh session can continue from, propose updates to the project's durable docs, apply them on approval or with `auto`. Use before compacting or clearing context, or on "pre-compact". |
